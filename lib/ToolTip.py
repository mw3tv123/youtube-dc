...
class Tooltip:
    ...
    def __init__(self, widget,
        ...
        self.wait_time = wait_time  # in milliseconds, originally 500
    ...
    def show(self):
        def tip_pos_calculator(widget, label,
            ...
            if offscreen_again:
                ...
                wrap_length when the tooltip is too high to be
...
if __name__ == '__main__':
    ...
    def main_01(wrap_length=200):
        ...
        Tooltip(btn_nw, text='North West' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_ne, text='North East' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_se, text='South East' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_sw, text='South West' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_center, text='Center' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_n, text='North' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_e, text='East' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_s, text='South' + stuff(), wrap_length=wrap_length)
        Tooltip(btn_w, text='West' + stuff(), wrap_length=wrap_length)
        ...
        root.title('Tooltip wrap_length = {}'.format(wrap_length))
        root.mainloop()


    def main():
        print('Trying out three different wrap_lengths:')
